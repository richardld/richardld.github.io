...
function preload() {
  ...
  orbit1 = [[javascript, "I have 2+ years of JavaScript experience! I've used JavaScript to many websites, including this one."], [html5, "I have 3+ years of HTML5 experience! Check out the projects tab to see some websites I have made."], [java, "I have 5+ years of Java experience! I've used Java to publish an app and create numerous programs."], [python, "I have 3+ years of Python experience! I've used it to create programs for tax analysis and more."]];
